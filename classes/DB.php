...
class DB {
    ...
    public static function getInstance() {
        /* 
        This function will first check if we've already instantiated an instance it will simply return th instance,
    ...
    /*
    DB::getInstance()->query("SELECT * FROM user_info WHERE username = ?", array('LUCIFER')); HERE LUCIFER shuld be replaced
